...
function BdcPrimer({ selectedFund }: { selectedFund: Fund | "All" }) {
  const scope = selectedFund === "All" ? "the sixteen verified BDCs" : selectedFund;
  return (
    <Panel
      title="BDC Primer"
      subtitle={`Plain-language context for reading ${selectedFund === "All" ? "the sixteen-fund verified private credit dataset" : `${selectedFund}'s private credit data`}.`}
      icon={Info}
    >
      ...
      <p className="bdc-primer-source">
        Source context: SEC Investor.gov BDC bulletin and the sixteen reconciled filing datasets in the verified tracker.
      </p>
    </Panel>
  );
}
...
function KeyObservations() {
  ...
  return (
    <Panel
      ...
      subtitle="Quantitative read from the latest common-period sixteen-fund verified dataset."
      icon={Info}
    >
    ...
    <div className="grid">
      ...
      <div className="grid kpi-grid">
        ...
        <MetricCard
          ...
          note="Sixteen reconciled holdings funds through Q1 2026; HTGC also has Q2 2026."
          icon={ShieldCheck}
        />
      </div>
      ...
      <Callout title="How to read coverage">
        ...
        Schedule of Investments dataset. A bulk-data badge is a discovery signal, not a validation stamp. Only the sixteen
    ...
    <div className="grid">
      ...
      <div className="grid kpi-grid">
        ...
        <MetricCard
          ...
          note={selectedFund === "All" ? "Across the current sixteen-fund borrower universe." : `Among borrowers currently held by ${selectedFund}.`}
          icon={AlertTriangle}
        />
        <MetricCard
    ...
    <main className="app-shell">
      ...
      <section className="research-workspace">
        <header className="topbar">
          ...
          <div className="brand">
            <p className="eyebrow">Sixteen public BDCs / {data.meta.latest_period_label}</p>
